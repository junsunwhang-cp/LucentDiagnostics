...
public class MetadataUserDetails implements UserDetails, User {
    ...
    public LucentFlowContext getLucentFlowContext() {
		return lucentFlowContext;
	}

	public void setLucentFlowContext(LucentFlowContext lucentFlowContext) {
		this.lucentFlowContext = lucentFlowContext;
	}
