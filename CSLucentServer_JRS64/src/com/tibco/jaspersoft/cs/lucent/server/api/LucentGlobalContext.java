...
//	}
	...
	public void addEntry(String entryCategoryId, long startTimeMs, long elapsedTimeNs){
		lucentConfiguration.getDataStore().writeLogEntry(new LogEntryImpl(entryCategoryId, startTimeMs, elapsedTimeNs, null));
	}
	
	public void addEntry(String entryCategoryId, long startTimeMs, long elapsedTimeNs, Object value){
